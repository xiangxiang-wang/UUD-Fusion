...
def test(test_dataloader, args):
    ...
    for i_test, (image1, image2) in enumerate(test_dataloader):
        ...
        #                                                             n=image1.shape[0])
        x_noise, sampled_images1 = net.diffusion.sample_from_blur14(net.unet, image1, x_init, image2,
                                                                    n=image1.shape[0])
        x_noise, sampled_images2 = net.diffusion.sample_from_blur14(net.unet,image2, x_init, image1,
                                                                    n=image1.shape[0])
        # sampled_images1 = image1
...
def parse_args():
    ...
    parser.add_argument('--testData_dir', type=str,
                        default=r"F:\test_dataset\Roadscene_select2")
    # parser.add_argument('--testData_dir', type=str,
    #                     default=r"F:\test_dataset\MSRS_select2")
    # parser.add_argument('--testData_dir', type=str,
    #                     default=r"F:\test_dataset\TNO_select2")
