# harvard,gfp,histological harvard0913-4 ourgfp0914-2 ourhistological0914
import torch
...
def test(test_dataloader, args):
    ...
    # pretrained_checkpoint_path = r'E:\saveModel_dir_pretrain19-3\epoch_74_loss_0.429036.pth'
    ...
    for i_test, (image1, image2) in enumerate(test_dataloader):
        ...
        # x_noise, sampled_images1 = net.diffusion.sample_from_blur9(net.unet,  x_init, image2, image1, n=image1.shape[0])
        ...
        # x_noise, sampled_images1 = net.diffusion.sample_from_blur14(net.unet,  sampled_images_, image1, sampled_images_,
        #                                                             n=image1.shape[0])
        # x_noise, sampled_images2 = net.diffusion.sample_from_blur14(net.unet,  sampled_images_, image2,sampled_images_,
        #                                                             n=image1.shape[0])
        # x_noise, sampled_images1 = net.diffusion.sample_from_blur14(net.unet, sampled_images_, image2, image1,
        #                                                             n=image1.shape[0])
        ...
        # x_noise, sampled_images1 = net.diffusion.sample_from_blur14(net.unet, sampled_images_,  image1,image2,
        #                                                             n=image1.shape[0])
        # x_noise, sampled_images2 = net.diffusion.sample_from_blur14(net.unet, sampled_images1, x_init, sampled_images1,
        #                                                             n=image1.shape[0])
        x_noise, sampled_images2 = net.diffusion.sample_from_blur14(net.unet, sampled_images1, x_init, sampled_images1,
                                                                    n=image1.shape[0])
        # x_noise, sampled_images2 = net.diffusion.sample_from_blur16(net.unet, sampled_images1, image1, image2,
        #                                                             n=image1.shape[0])
        ...
        # sampled_images1 = sampled_images1 + image2
        # sampled_images1 = torch.max(sampled_images1, image2)
        ...
        # x_noise, sampled_images1 = net.diffusion.sample_from_blur14(net.unet, image1, image1, image2, n=image1.shape[0])
        ...
        # sampled_images1=image1+sampled_images1
        # _, sampled_images2 = net.ch_att(sampled_images_, sampled_images2)
        # sampled_images1, sampled_images2 = net.ch_att(sampled_images1, sampled_images2)
        # _, sampled_images1 = net.ch_att(image1, sampled_images1)
        _, sampled_images2 = net.ch_att(image2, sampled_images2)
        # sampled_images1, sampled_images2 = net.ch_att(sampled_images1, sampled_images2)
        ...
        # sampled_images1, sampled_images2 = net.ch_att(sampled_images_, sampled_images2)
        # sampled_images1 = sampled_images1+image1
        # sampled_images = sampled_images_ +image1
        # sampled_images2 =torch.max(sampled_images2, image2)
        # sampled_images1, sampled_images2 = net.ch_att(sampled_images1, sampled_images2)
        ...
        # sampled_images = sampled_images + image2
        # sampled_images1 = image2
...
def parse_args():
    ...
    parser.add_argument('--testData_dir', type=str,
                        default=r"F:\test_dataset\Harvard_select2")
    # parser.add_argument('--testData_dir', type=str,
    #                     default=r"F:\test_dataset\GFP_select2")
    # parser.add_argument('--testData_dir', type=str,
    #                     default=r"F:\test_dataset\Histological_select2")
    ...
    # parser.add_argument('--saveModel_dir', type=str, default='E:/saveModel_dir_fusion39-4/epoch_126_loss_0.377730.pth')
