...
def train(train_loader, args):
    ...
    checkpoint_path = r'E:\saveModel_dir_pretrain19-2\epoch_76_loss_0.666261.pth'
...
def parse_args():
    ...
    parser.add_argument('--dataset_dir', type=str, default='E:/set1/CVC-14/Train')
    parser.add_argument('--saveModel_dir', type=str, default='E:/saveModel_dir_fusion39-3/')
...
if __name__ == '__main__':
    ...
    transforms_ = [transforms.Resize((64, 64)),
                   ...
                   transforms.ToTensor()]
    train_set = CVC14(dataset_dir=args.dataset_dir, transforms_=transforms_, rgb=True)
